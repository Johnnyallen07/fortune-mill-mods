...
grep -F "currency=5x general-bonus=1x zenith-bonus=10x upgrade-growth=1.25x trial-multi<=10000x dart-bullseye-size<=1x dart-bullseye-count<=20" /tmp/fortune-mill-patcher-verify.log >/dev/null
